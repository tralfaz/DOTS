...
(defun tpu-set-frame-size (width height)
  "Set the current frames charact width and height size."
  (interactive "nwidth: \nnheight: ")
...
;;;  Define keymaps
;;;
(define-key global-map [clear] GOLD-map)                      ; GOLD map
...
(define-key global-map [kp-equal] 'tpu-help)                         ; PF2
(define-key global-map [kp-divide] 'tpu-search-again)                 ; PF3
(define-key global-map [kp-multiply] 'tpu-delete-current-line)          ; PF4
...
(define-key GOLD-map "\\" 'apply-macro-to-region-lines)       ; GOLD-"\"
...
(define-key GOLD-map [kp-equal] 'help-for-help)                  ; PF2
(define-key GOLD-map [kp-divide] 'tpu-search)                     ; PF3
(define-key GOLD-map [kp-multiply] 'tpu-undelete-lines)             ; PF4
