...
;;;  Define keymaps
;;;
(define-key global-map [kp-f1] GOLD-map)                      ; GOLD map
...
(define-key global-map [kp-f2] 'tpu-help)                         ; PF2
(define-key global-map [kp-f3] 'tpu-search-again)                 ; PF3
(define-key global-map [kp-f4] 'tpu-delete-current-line)          ; PF4
...
(define-key GOLD-map "F" 'find-file)                          ; GOLF-F
...
(define-key GOLD-map [kp-f1] 'keyboard-quit)                  ; PF1
(define-key GOLD-map [kp-f2] 'help-for-help)                  ; PF2
(define-key GOLD-map [kp-f3] 'tpu-search)                     ; PF3
(define-key GOLD-map [kp-f4] 'tpu-undelete-lines)             ; PF4
